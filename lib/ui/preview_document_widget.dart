          ...
          return Container(
            ...
            child: Wrap(
              children: <Widget>[
                ...
                ListTile(
                  leading: Icon(Icons.picture_as_pdf),
                  title: Text('Create as PDF with OCR'),
                  onTap: () {
                    Navigator.pop(context);
                    _createOcrPdf();
                  },
            ...
            child: ListView(
              children: [
                MenuItemWidget(
                  ...
                  onTap: () {
                    Share.shareFiles([pdfFileUri.toFilePath()]);
                  },
                ),
                MenuItemWidget(
                  "Rename Pdf",
            ...
            child: ListView(
              children: [
                MenuItemWidget(
                  ...
                  endIcon: Icons.arrow_forward,
                  onTap: () {
                    Share.shareFiles([tiffFileUri.toFilePath()]);
                  },
                ),
              ],
            ),
